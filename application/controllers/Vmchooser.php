...
class Vmchooser extends CI_Controller {
	...
	public function disk()
	{
		...
		else
		{
			...
			$querysuffix = "?currency=$inputCurrency&ssd=$ssd&region=$inputRegion&iops=$inputIops&data=$inputData&throughput=$inputThroughput&maxdisks=$inputMaxDisks";
			$telemetryClient->trackEvent('Index : API Call');
